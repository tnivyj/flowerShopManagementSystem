        ...
        <div id="container">
            <div id="header">
                ...
                <ul class="oe_menu">
                    ...
                    <li><a href="Supplier.html" id="gongyingshang">供应商</a></li>
            ...
            <div id="page">
                <div class="haha">
                    <a href="SupplierSearch.php"><input type="button" class="button search" value="查询"></a>
                </div>
                <div class="demo">
                    <form name="search" action="<?php $_SERVER['PHP_SELF'] ?>" method="post"><br><br>
                        查询供应商：<input name="search" type="text">
                    ...
                    <?php
                        if(isset($_POST['search'])){
                            ...
                            echo '<tr><th>供应商编号</th><th>名字</th><th>地址</th><th>电话</th></tr>';
                            $link = mysqli_connect('localhost','root','','FinalExam');
                            mysqli_query($link,'set names utf8');
                            $result = mysqli_query($link,"SELECT * FROM Supplier WHERE Sname like'%{$searchName}%'");
                            while($obj = $result->fetch_object()){
                            print_r('<tr><td>'.$obj->Sid.'</td><td>'.$obj->Sname.'</td><td>'.$obj->Slocation.'</td><td>'.$obj->Sphone.'</td></tr>');
                        }
                            mysqli_close($link);
                            echo '</table>';
                        }
