            ...
            <div id="page">
                ...
                <div class="demo">
                    <form name="search" action="<?php $_SERVER['PHP_SELF'] ?>" method="post"><br><br>
                        查询供应订单：<input name="search" type="text">
                    ...
                    <?php
                        if(isset($_POST['search'])){
                            ...
                            echo '<tr><th>花编号</th><th>供应商编号</th><th>数量</th><th>供应日期</th></tr>';
                            $link = mysqli_connect('localhost','root','','FinalExam');
                            mysqli_query($link,'set names utf8');
                            $result = mysqli_query($link,"SELECT * FROM Supply WHERE C_Fid like'%{$searchName}%'");
